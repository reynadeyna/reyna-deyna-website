...
const Music = () => {
  const widgets = [
    {
      ...
      description:
        "System Error I will reach you through the wire. Who Am I? Try to decrypt it. I erase everything. I am naked and bare, but my server is in order. Attack of the year, computer virus, Titty Pop Smoke. There’s too much of me here. As vaziuoju letai kad matytu velnei and no one does it like me.",
    },
    {
      type: "img",
  ...
  return (
    <div className="flex justify-center px-4 py-20 bg-black min-h-screen">
